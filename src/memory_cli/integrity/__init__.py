...
# --- Public API exports (uncomment as modules are implemented) ---

# Startup drift check — called on every CLI invocation
# from memory_cli.integrity.startup_drift_check_model_and_dims import run_startup_drift_check
...
# from memory_cli.integrity.meta_check_orphans_and_anomalies import run_meta_check
