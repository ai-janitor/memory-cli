...
def show_top_level_help(registry: Dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "",
        "New here?",
        "  memory manpage how-to       Agent onboarding guide — start here",
        "  memory gate show            See what's in this store (entry point)",
        "  memory meta manifesto       What's worth storing",
        "",
